    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-white">
      ...
      <div className="w-full md:w-[55%] flex items-center justify-center p-6 py-12 md:p-12 bg-slate-50/50">
        <div className="w-full max-w-[500px] bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 p-8 md:p-10">
          ...
          <div className="mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-2">Hello, Selamat Datang</h2>
            <p className="text-slate-500 text-sm">Silahkan masuk ke akunmu untuk meraih masa depan yang cerah</p>
          </div>
          ...
          <Form onSubmit={handleSubmit} className="space-y-6">
            ...
            <FormGroup>
              <div className="relative">
                <div className="flex justify-between items-center absolute w-full top-[-28px]">
                  {/* Label ditangani manual agar sejajar dengan link lupa sandi */}
                </div>
                <div className="flex justify-between items-center mb-2">
                  <label className="block text-sm font-medium text-secondary-800">Kata Sandi</label>
                  <Link href="/auth/forgot-password" className="text-sm font-bold text-[#0B3B60] hover:underline">
                    Lupa Kata Sandi?
                  </Link>
                </div>
            ...
            <div className="flex items-center gap-3">
              <input 
                ...
                className="w-4 h-4 rounded border-slate-300 text-[#0B3B60] focus:ring-[#0B3B60]"
              />
          ...
          <p className="text-center text-slate-600 text-sm mt-8">
            Belum punya akun?{' '}
            <Link href="/auth/register" className="text-[#0B3B60] font-bold hover:underline">
              Daftar Sekarang!
            </Link>
          </p>
        </div>
